...
import (
	...
	"io/ioutil"
	"net/http"
	sap_api_output_formatter "sap-api-integrations-lead-reads/SAP_API_Output_Formatter"
	"strings"
	"sync"
...
func (c *SAPAPICaller) LeadCollection(iD string) {
	leadCollectionData, err := c.callLeadSrvAPIRequirementLeadCollection("LeadCollection", iD)
	if err != nil {
		c.log.Error(err)
		return
	}
